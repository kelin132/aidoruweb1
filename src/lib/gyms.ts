...
export const GYM_DEFINITIONS: GymDefinition[] = [
  ...
  },
  {
    ...
    unlockAfter: "storm",
    team: [
      { name: "Alakazam", pokedexId: 65, level: 98, types: ["psychic"], maxHp: 820, attack: 520, defense: 430, speed: 260, moves: [move("Psychic Burst", "psychic", 120), move("Elder Strike", "psychic", 140)] },
      { name: "Lunala", pokedexId: 792, level: 100, types: ["psychic"], maxHp: 980, attack: 560, defense: 470, speed: 220, moves: [move("Psychic Burst", "psychic", 120), move("Elder Strike", "psychic", 140)] },
      { name: "Alakazam", pokedexId: 65, level: 101, types: ["psychic"], maxHp: 900, attack: 580, defense: 500, speed: 280, moves: [move("Psychic Burst", "psychic", 120), move("Elder Strike", "psychic", 140)] },
      { name: "Reuniclus", pokedexId: 579, level: 102, types: ["psychic"], maxHp: 940, attack: 590, defense: 520, speed: 130, moves: [move("Psychic Burst", "psychic", 120), move("Elder Strike", "psychic", 140)] },
      { name: "Mesprit", pokedexId: 481, level: 104, types: ["psychic"], maxHp: 1000, attack: 620, defense: 550, speed: 240, moves: [move("Psychic Burst", "psychic", 120), move("Elder Strike", "psychic", 140)] },
      { name: "Arceus", pokedexId: 493, level: 108, types: ["psychic"], maxHp: 1300, attack: 720, defense: 650, speed: 300, moves: [move("Psychic Burst", "psychic", 120), move("Elder Strike", "psychic", 140)] },
    ],
  },
  {
    id: "void",
    ...
    unlockAfter: "astral",
    team: [
      { name: "Absol", pokedexId: 359, level: 106, types: ["dark"], maxHp: 880, attack: 540, defense: 420, speed: 280, moves: [move("Dark Burst", "dark", 120), move("Elder Strike", "dark", 140)] },
      { name: "Zoroark", pokedexId: 571, level: 108, types: ["dark"], maxHp: 900, attack: 560, defense: 420, speed: 300, moves: [move("Dark Burst", "dark", 120), move("Elder Strike", "dark", 140)] },
      { name: "Hydreigon", pokedexId: 635, level: 110, types: ["dark"], maxHp: 1100, attack: 680, defense: 560, speed: 250, moves: [move("Dark Burst", "dark", 120), move("Elder Strike", "dark", 140)] },
      { name: "Yveltal", pokedexId: 717, level: 112, types: ["dark"], maxHp: 1250, attack: 700, defense: 600, speed: 270, moves: [move("Dark Burst", "dark", 120), move("Elder Strike", "dark", 140)] },
      { name: "Darkrai", pokedexId: 491, level: 114, types: ["dark"], maxHp: 1300, attack: 760, defense: 640, speed: 290, moves: [move("Dark Burst", "dark", 120), move("Elder Strike", "dark", 140)] },
      { name: "Tyranitar", pokedexId: 248, level: 116, types: ["dark"], maxHp: 1400, attack: 820, defense: 700, speed: 220, moves: [move("Dark Burst", "dark", 120), move("Elder Strike", "dark", 140)] },
    ],
  },
  {
    id: "dragon-elder",
    ...
    unlockAfter: "void",
    team: [
      { name: "Garchomp", pokedexId: 445, level: 118, types: ["dragon"], maxHp: 1250, attack: 760, defense: 680, speed: 330, moves: [move("Dragon Burst", "dragon", 120), move("Elder Strike", "dragon", 140)] },
      { name: "Salamence", pokedexId: 373, level: 120, types: ["dragon"], maxHp: 1280, attack: 780, defense: 650, speed: 340, moves: [move("Dragon Burst", "dragon", 120), move("Elder Strike", "dragon", 140)] },
      { name: "Haxorus", pokedexId: 612, level: 122, types: ["dragon"], maxHp: 1300, attack: 820, defense: 650, speed: 320, moves: [move("Dragon Burst", "dragon", 120), move("Elder Strike", "dragon", 140)] },
      { name: "Rayquaza", pokedexId: 384, level: 125, types: ["dragon"], maxHp: 1600, attack: 900, defense: 820, speed: 380, moves: [move("Dragon Burst", "dragon", 120), move("Elder Strike", "dragon", 140)] },
      { name: "Reshiram", pokedexId: 643, level: 128, types: ["dragon"], maxHp: 1700, attack: 960, defense: 850, speed: 350, moves: [move("Dragon Burst", "dragon", 120), move("Elder Strike", "dragon", 140)] },
      { name: "Baxcalibur", pokedexId: 998, level: 130, types: ["dragon"], maxHp: 1550, attack: 940, defense: 800, speed: 300, moves: [move("Dragon Burst", "dragon", 120), move("Elder Strike", "dragon", 140)] },
    ],
  },
];
